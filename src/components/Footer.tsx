    ...
    <footer className="bg-[#04342C] text-[#E1F5EE] pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-5 gap-8 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><Link href="/status" className="hover:text-[#1AEEAF] transition-colors text-xs font-light">{t.footer.statut}</Link></li>
            <li><Link href="/developers" className="hover:text-white transition-colors text-xs font-light">{t.footer.docs}</Link></li>
