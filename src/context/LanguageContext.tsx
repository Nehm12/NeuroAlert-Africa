...
const dictionary_fr = {
  ...
  "hero": {
    "badge": "L'IA Mondiale pour Tous",
    "title": "La puissance de l'IA.\nZéro Internet\nRequis.",
    "subtitle": "La première détection d'AVC par Intelligence Artificielle qui fonctionne sans smartphone. Apportez la puissance de Google Gemini sur n'importe quel téléphone, partout.",
    "cta": "Accès Institutions"
  },
  "home_features": {
    "title": "IA Inclusive & Triage",
    "desc": "NeuroAlert redéfinit l'urgence via une IA accessible par simple onde radio. Nous apportons l'IA de pointe là où la 4G ne parvient pas.",
    "card1_title": "IA Globale via GSM",
    "card1_desc": "Inférence neuronale Google Gemini sur infrastructure GSM héritée (Zero-Data).",
    "card2_title": "Géo-Triangulation Offline",
    "card2_desc": "Dispatching d'urgence haute précision sans GPS ni internet dans les zones reculées.",
    "card3_title": "NLP Dialectal Sans Internet",
    "card3_desc": "Analyse vocale et textuelle en Haoussa, Yoruba et Igbo sans aucune connexion cloud requise pour l'utilisateur.",
    "card4_title": "Télémétrie HIS Cloud-Link",
    "card4_desc": "Synchronisation instantanée avec les hôpitaux dès qu'une alerte IA est générée.",
    "card5_title": "Architectures Zero-HTTP",
    "card5_desc": "Disponibilité critique même en l'absence totale de couverture internet.",
    "card6_title": "Clinical AI Standard",
    "card6_desc": "Standardisation médicale internationale portée sur les réseaux mobiles via IA-USSD."
  },
  "how_it_works": {
    "title": "Intelligence Artificielle Mondiale via *789#",
    "step1_title": "Composez le *789#",
    "step1_desc": "Zéro Data. Zéro Smartphone. Juste l'IA Pure via USSD sur tous les types de téléphones.",
    "step2_title": "IA Guide le Triage",
    "step2_desc": "Notre moteur d'IA vous guide à travers le test F.A.S.T dans votre langue locale.",
    "step3_title": "Alerte IA Instantanée",
    "step3_desc": "Si l'IA détecte une urgence, l'alerte est poussée immédiatement aux secours."
  },
  "product": {
    "badge": "Ingénierie Clinique",
    "vanguard_badge": "VANGUARD CLINICAL GRADE",
    "title": "L'Agent Neuronal USSD",
    ...
    "card1_title": "Inférence IA-GSM Native",
    "card1_desc": "Protocoles diagnostiques dématérialisés tournant sur infrastructure GSM (Zero-HTTP).",
    "card2_title": "Géo-Triangulation Radio",
    "card2_desc": "Localisation d'urgence par maillage d'antennes relais, sans GPS et sans internet.",
    "card3_title": "Dialect NLP Inference",
    "card3_desc": "Modèles de langage optimisés pour les dialectes africains (Français, Hausa, Yoruba, Igbo).",
    "cta_title": "L'IA pour tous. Partout.",
    "cta_desc": "Hôpitaux connectés via le dashboard NeuroAlert pour une intervention en moins de 60s, peu importe le téléphone du patient.",
    "cta_btn": "Voir le Dashboard",
    "triage_feed": "Flux de Triage Live",
    "mesh_title": "Architecture Zero-Data",
  ...
  "about": {
    "badge": "L'IA Inclusive",
    "title": "Pionniers de l'IA Mondiale.",
    "desc": "NeuroAlert Africa est une initiative d'ingénierie médicale visant à éradiquer la mortalité évitable due aux AVC via l'intelligence artificielle accessible sans internet.",
    "mission_title": "Notre Mission",
    "mission_p1": "Démocratiser l'IA pour sauver des vies là où la technologie s'arrête. Nous servons 1,3 milliard de personnes sans dépendance au haut débit.",
    "vision_title": "Notre Vision",
    "vision_p1": "Devenir le standard de triage neurologique mondial pour toutes les zones du monde, avec ou sans internet.",
    "problem_title": "L'Urgence",
    "problem_p1": "L'AVC tue massivement en Afrique, souvent à cause de l'absence de moyens de détection simples et accessibles.",
    "problem_p2": "L'IA ne doit pas être un privilège. Elle doit être un droit, accessible même sur un téléphone à 10$.",
    "stats_problem": "Cas avec Diagnostic Tardif",
    "solution_title": "Innovation AI-through-USSD",
    "solution_p1": "Notre moteur FAST AI analyse les symptômes en temps réel via de simples sessions USSD.",
    "solution_p2": "Nous connectons l'IA Google Gemini aux téléphones 'feature' les plus basiques.",
  ...
  "team": {
    ...
    "founder1_name": "Nehm Hounga",
    "founder1_role": "CEO & Co-founder",
    "founder2_name": "Dr. Luam Viderot",
    "founder2_role": "Doctorant en Neurologie & Co-founder",
    "builder1_name": "Emmanuel Santos",
    "builder1_role": "Lead IA/ML",
    "builder2_name": "Murielle Kpinso",
    "builder2_role": "Lead UX/UI",
    "builder3_name": "Prince Kangbode",
    "builder3_role": "Lead Backend",
    "builder4_name": "Ines",
    "builder4_role": "IA/ML",
    "expert1_name": "Dr. Adda Alix",
    "expert1_role": "Neurologue",
    "mentor1_name": "Archille Sonehekpon",
    "mentor1_role": "MBA- CEO Sonarc Corporate",
    "mentor2_name": "Malick Amadou",
    "mentor2_role": "CEO SGO AGA MBA-Finances"
  },
  "faq": {
    "title": "FAQ",
...
const dictionary_en = {
  ...
  "hero": {
    "badge": "Global AI for Everyone",
    "title": "The Power of AI.\nZero Internet\nRequired.",
    "subtitle": "The first AI-powerd stroke triage that works without internet. Bring the power of Google Gemini to any phone, anywhere, on any network.",
    "cta": "Institution Access"
  },
  "home_features": {
    "title": "Inclusive AI & Triage",
    "desc": "NeuroAlert redefines emergency via AI accessible through simple radio waves. Bringing top-tier intelligence to where broadband stops.",
    "card1_title": "Global AI via GSM",
    "card1_desc": "Google Gemini neural inference on legacy GSM infrastructure (Zero-Data).",
    "card2_title": "Offline Geo-location",
    "card2_desc": "GPS-less high-precision emergency dispatch and mapping for remote zones.",
    "card3_title": "Offline Multi-Dialectal NLP",
    "card3_desc": "Automatic symptom detection in Hausa, Yoruba, and Igbo with zero cloud connection needed for the user.",
    "card4_title": "HIS Cloud-Link Telemetry",
    "card4_desc": "Instant sync with hospital management systems (OpenMRS/DHIS2) upon AI alert.",
    "card5_title": "Zero-HTTP Architecture",
    "card5_desc": "Mission-critical operations in total absence of internet or data coverage.",
    "card6_title": "Clinical AI Standard",
    "card6_desc": "International medical standards deployed on mobile networks via AI-USSD."
  },
  "how_it_works": {
    "title": "Global AI Access via *789#",
    "step1_title": "Dial *789#",
    "step1_desc": "No Data. No Smartphone. Just Pure AI through USSD on any device.",
    "step2_title": "AI-Guided Triage",
    "step2_desc": "Interactive menu in your language, powered by neural intelligence.",
    "step3_title": "Instant AI Alert",
    "step3_desc": "Critical alerts pushed to hospitals via our secure backbone."
  },
  "product": {
    ...
    "card1_title": "Native AI-GSM Inference",
    "card1_desc": "Dematerialized diagnostic protocols running on regional GSM infrastructure (Zero-HTTP).",
    "card2_title": "Radio Geo-Triangulation",
    "card2_desc": "Emergency location via carrier antenna mesh, no GPS and no internet required.",
    "card3_title": "Native NLP Inference",
    "card3_desc": "LLM-optimized diagnostics for African dialects (English, Hausa, Yoruba, Igbo).",
    "cta_title": "AI for everyone. Anywhere.",
    "cta_desc": "Hospitals connected via NeuroAlert dashboard for interventions in under 60 seconds, regardless of user phone type.",
    "cta_btn": "View Physician Dashboard",
    "triage_feed": "Live Triage Feed",
    "mesh_title": "Zero-Data Architecture",
  ...
  "about": {
    "badge": "Inclusive AI",
    "title": "Pioneers of Global AI Access.",
    "desc": "NeuroAlert Africa is a medical engineering initiative dedicated to eradicating preventable stroke mortality through AI accessible without internet.",
    "mission_title": "Our Mission",
    "mission_p1": "Democratizing AI to save lives where technology stops. Serving 1.3 billion people without broadband dependence.",
    "vision_title": "Our Vision",
    "vision_p1": "To become the global neurological triage standard for all areas of the world, with or without internet.",
    "problem_title": "The Emergency",
    "problem_p1": "Stroke kills massively in Africa, often due to the lack of simple and accessible detection tools.",
    "problem_p2": "AI should not be a privilege. It must be a right, accessible even on a $10 phone.",
    "stats_problem": "Cases with Late Diagnosis",
    "solution_title": "AI-through-USSD Innovation",
    "solution_p1": "Our FAST AI engine analyzes symptoms in real-time through simple USSD sessions.",
  ...
  "team": {
    ...
    "founder1_role": "CEO & Co-founder",
    "founder2_name": "Dr. Luam Viderot",
    "founder2_role": "PhD Student Neurology & Co-founder",
    "builder1_name": "Emmanuel Santos",
    "builder1_role": "Lead IA/ML",
    "builder2_name": "Murielle Kpinso",
    "builder2_role": "Lead UX/UI",
